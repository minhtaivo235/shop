				...
				<div class="row d-flex">
					...
					<div
						...
						<c:if test="${not empty USERMODEL }">
							<span class="text icon-user"> <a href="<c:url value=""/>"
								class="text mr-4">Welcom, ${USERMODEL.fullname}</a>
							</span>
							<span> <a href="<c:url value="/thoat?action=logout"/>"
								class="text">Thoát</a>
							</span>
						</c:if>
						<c:if test="${empty USERMODEL }">
							<span class="text icon-user"> <a
								href="<c:url value="/dang-nhap?action=login"/>" class="text">
									SIGN UP</a>
							</span>
						</c:if>
					</div>
