										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm bài viết' href='<c:url value="/admin-category?type=edit"/>'>
															<span>
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table class="table table-bordered">
												...
												<tbody>
													<c:forEach var="item" items="${categories.listResult}"> <!--lặp list trong abstractModel -->
														<tr>
															<td>${item.name}</td>
															<td>${item.code}</td>
															<td>
											...
											<!-- name phải trùng tên với thuộc tính trong model -->
										</div>
									</div>
								</div>
							</div>
